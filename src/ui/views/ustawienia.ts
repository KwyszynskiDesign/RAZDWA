...
const PRICE_LABELS: Record<string, string> = {
  ...
  "laminowanie-oprawa-grzbietowa-a4-do50": "Oprawa grzbietowa (listwa wsuwana) A4 – do 30 str.",
  ...
  "laminowanie-oprawa-grzbietowa-a3-do50": "Oprawa grzbietowa (listwa wsuwana) A3 – do 30 str.",
