...
const PRICE_LABELS: Record<string, string> = {
  ...
  "laminowanie-oprawa-grzbietowa-a4-do50": "Oprawa grzbietowa (listwa wsuwana) A4 – do 50 str.",
  ...
  "laminowanie-oprawa-grzbietowa-a3-do50": "Oprawa grzbietowa (listwa wsuwana) A3 – do 50 str.",
...
const BASE_PRICE_CATEGORIES: PriceCategory[] = [
  ...
  },
  {
    ...
    description: "Cenniki solwentu i plakatów A4-A3 (mały/duży Canon; 130g i 170g mają tę samą cenę).",
