...
(function () {
  ...
  const FORMAT_MATERIALS = {
    '120g-formatowe': {
      name: '120g Formatowe',
      discountGroup: '120g',
      prices: { '297x420': 12, '420x594': 18, '610x841': 28, '841x1189': 54, '914x1292': 65, 'rolka1067': 63 },
    },
    '120g-nieformatowe': {
      name: '120g Nieformatowe',
      discountGroup: '120g',
      prices: { '297x420': 28, '420x594': 30, '610x841': 33, '841x1189': 45, '914x1292': 50, 'rolka1067': 63 },
    },
    '260g-satyna-formatowe': {
      name: '260g Satyna Formatowe (fotoplakaty)',
      discountGroup: '260g',
      prices: { '297x420': 23, '420x594': 30, '594x841': 50, '841x1189': 80, '914x1292': 88 },
    },
    '260g-satyna-nieformatowe': {
      name: '260g Satyna Nieformatowe (fotoplakaty)',
      discountGroup: '260g',
      prices: { '297x420': 47.60, '420x594': 50, '594x841': 59.50, '841x1189': 66.70, '914x1292': 73.30 },
    },
    '180g-pp-formatowe': {
      name: '180g PP Formatowe',
      discountGroup: '120g',
      prices: { '297x420': 18.80, '420x594': 27, '610x841': 45.40, '841x1189': 75, '914x1292': 90 },
    },
    '180g-pp-nieformatowe': {
      name: '180g PP Nieformatowe',
      discountGroup: '120g',
      prices: { '297x420': 43.50, '420x594': 45, '610x841': 54, '841x1189': 62, '914x1292': 70 },
    },
  };
  ...
  const DISCOUNTS = {
    '120g': [
      ...
      { min: 21, max: 300,  factor: 0.87 },
    ],
    '260g': [
      { min: 9,  max: 20,   factor: 0.93 },
      { min: 21, max: 300,  factor: 0.88 },
    ],
  };
