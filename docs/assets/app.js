var Be=Object.defineProperty;var Re=(e,t)=>{for(var r in t)Be(e,r,{get:t[r],enumerable:!0})};var K=class{routes=new Map;currentView=null;container;getCtx;categories=[];constructor(t,r){this.container=t,this.getCtx=r,window.addEventListener("hashchange",()=>this.handleRoute())}setCategories(t){this.categories=t}addRoute(t){this.routes.set(t.id,t)}handleRoute(){let r=(window.location.hash||"#/").slice(2);this.currentView&&this.currentView.unmount&&this.currentView.unmount(),this.container.innerHTML="";let a=this.routes.get(r);if(a){this.currentView=a;let i=document.createElement("button");i.className="back-button",i.textContent="Wszystkie kategorie",i.onclick=()=>{window.location.hash="#/"},this.container.appendChild(i);let o=document.createElement("div");o.className="category-content",o.id="current-category",this.container.appendChild(o),a.mount(o,this.getCtx())}else this.renderHome()}renderHome(){let t={};this.categories.forEach(a=>{let i=a.group||"Pozosta\u0142e";t[i]||(t[i]=[]),t[i].push(a)});let r="";for(let[a,i]of Object.entries(t))r+=`
    ...
    `;let r=0,a=e.querySelector("#calculate"),i=e.querySelector("#addToBasket"),o=e.querySelector("#total-price"),c=e.querySelector("#price-breakdown");a?.addEventListener("click",()=>{let d=e.querySelector("#format").value,l=parseInt(e.querySelector("#quantity").value)||1,m=e.querySelector("#sides").value,p=e.querySelector("#paper").value,f=We(l,m==="single"),n=u.register("vouchery-mod-satin","Vouchery","Dop\u0142ata Satyna",.12),y=u.register("vouchery-mod-express","Vouchery","Dop\u0142ata Express",.2),s=p==="satin"?1+n:1,g=t.expressMode?1+y:1;if(r=f*s*g,o&&(o.textContent=r.toFixed(2)+" z\u0142"),c){let x=VOUCHERY_PRICING[0];for(let w of VOUCHERY_PRICING)if(l>=w.qty)x=w;else break;c.textContent="Podstawa: "+f.toFixed(2)+" z\u0142 za "+l+" szt (przedzia\u0142: "+x.qty+"+ szt)"}t.updateLastCalculated(r,"Vouchery "+d+" "+(m==="single"?"jednostronne":"dwustronne")+" - "+l+" szt")}),i?.addEventListener("click",()=>{if(r===0){alert("\u26A0\uFE0F Najpierw oblicz cen\u0119!");return}let d=e.querySelector("#format").value,l=e.querySelector("#quantity").value,m=e.querySelector("#sides").value,p=e.querySelector("#paper").value;t.addToBasket({category:"Vouchery",price:r,description:d+" "+(m==="single"?"jednostronne":"dwustronne")+", "+l+" szt, "+(p==="satin"?"satyna":"standard")}),alert("\u2705 Dodano: "+r.toFixed(2)+" z\u0142")})}};var me=[{qty:1,price:20},{qty:2,price:30},{qty:3,price:32},{qty:4,price:34},{qty:5,price:35},{qty:6,price:35},{qty:7,price:36},{qty:8,price:37},{qty:9,price:39},{qty:10,price:40},{qty:15,price:45},{qty:20,price:49},{qty:30,price:58},{qty:40,price:65},{qty:50,price:75},{qty:100,price:120}];function Ke(e){let t=u.registerTiers("dyplomy","Dyplomy",me.map(a=>({min:a.qty,max:null,price:a.price}))),r=t[0];for(let a of t)if(e>=a.min)r=a;else break;return r.price}var pe={id:"dyplomy",name:"\u{1F393} Dyplomy",mount:(e,t)=>{e.innerHTML=`
      <div class="category-form">
    ...
    `;let r=0,a=e.querySelector("#calculate"),i=e.querySelector("#addToBasket"),o=e.querySelector("#total-price"),c=e.querySelector("#price-breakdown");a?.addEventListener("click",()=>{let d=parseInt(e.querySelector("#quantity").value)||1,l=e.querySelector("#paper").value,m=Ke(d),p=l==="satin"?1.12:1,f=t.expressMode?1.2:1;if(r=m*p*f,o&&(o.textContent=`${r.toFixed(2)} z\u0142`),c){let n=u.registerTiers("dyplomy","Dyplomy",me.map(s=>({min:s.qty,max:null,price:s.price}))),y=n[0];for(let s of n)if(d>=s.min)y=s;else break;c.textContent=`${d} szt, przedzia\u0142: ${y.min}+ szt \u2192 ${m.toFixed(2)} z\u0142${l==="satin"?" \xD7 1.12 (satyna)":""}`}t.updateLastCalculated(r,`Dyplomy DL - ${d} szt`)}),i?.addEventListener("click",()=>{if(r===0){alert("\u26A0\uFE0F Najpierw oblicz cen\u0119!");return}let d=e.querySelector("#quantity").value,l=e.querySelector("#paper").value;t.addToBasket({category:"Dyplomy",price:r,description:`DL dwustronny, ${d} szt, ${l==="satin"?"satyna":"standard"}`}),alert(`\u2705 Dodano: ${r.toFixed(2)} z\u0142`)})}};var Ue={"85x55":[{qty:50,plain:65,foil:160},{qty:100,plain:75,foil:170},{qty:150,plain:85,foil:180},{qty:200,plain:96,foil:190},{qty:250,plain:110,foil:200},{qty:300,plain:126,foil:220},{qty:400,plain:146,foil:240},{qty:500,plain:170,foil:250},{qty:1e3,plain:290,foil:335}],"90x50":[{qty:50,plain:70,foil:170},{qty:100,plain:79,foil:180},{qty:150,plain:89,foil:190},{qty:200,plain:99,foil:200},{qty:250,plain:120,foil:210},{qty:300,plain:129,foil:230},{qty:400,plain:149,foil:250},{qty:500,plain:175,foil:260},{qty:1e3,plain:300,foil:345}]};function Qe(e,t,r){let a=Ue[e],i=r?"foil":"plain",o=u.registerTiers(`wizytowki-${e}-${i}`,`Wizyt\xF3wki ${e} ${i}`,a.map(d=>({min:d.qty,max:null,price:r?d.foil:d.plain}))),c=o[0];for(let d of o)if(t>=d.min)c=d;else break;return c.price}var ue={id:"wizytowki",name:"\u{1F4BC} Wizyt\xF3wki",mount:(e,t)=>{e.innerHTML=`
      <div class="category-form">
    ...
    `;let r=0,a=e.querySelector("#calculate"),i=e.querySelector("#addToBasket"),o=e.querySelector("#total-price"),c=e.querySelector("#price-breakdown");a?.addEventListener("click",()=>{let d=e.querySelector("#format").value,l=parseInt(e.querySelector("#quantity").value),m=e.querySelector("#foiling").value;r=Qe(d,l,m==="foil"),t.expressMode&&(r*=1.2),o&&(o.textContent=`${r.toFixed(2)} z\u0142`),c&&(c.textContent=`Format ${d} mm, ${l} szt, ${m==="foil"?"z foli\u0105":"bez foliowania"}`),t.updateLastCalculated(r,`Wizyt\xF3wki ${d} - ${l} szt`)}),i?.addEventListener("click",()=>{if(r===0){alert("\u26A0\uFE0F Najpierw oblicz cen\u0119!");return}let d=e.querySelector("#format").value,l=e.querySelector("#quantity").value,m=e.querySelector("#foiling").value;t.addToBasket({category:"Wizyt\xF3wki",price:r,description:`${d} mm, ${l} szt, ${m==="foil"?"z foli\u0105":"bez foliowania"}`}),alert(`\u2705 Dodano: ${r.toFixed(2)} z\u0142`)})}};var ae={name:"Zaproszenia KREDA - druk cyfrowy",modifiers:{satin:.12,express:.2},formats:{A6:{name:"A6 (105x148mm)",single:{normal:{"10":30,"24":40,"32":45,"50":50,"75":60,"100":68,"150":79},folded:{"10":45,"24":55,"32":60,"50":71,"75":84,"100":99,"150":126}},double:{normal:{"10":35,"24":46,"32":57,"50":66,"75":79,"100":89,"150":115},folded:{"10":58,"24":66,"32":84,"50":105,"75":125,"100":149,"150":199}}},A5:{name:"A5 (148x210mm)",single:{normal:{"10":34,"24":42,"32":48,"50":55,"75":63,"100":79,"150":110},folded:{"10":55,"24":60,"32":75,"50":95,"75":125,"100":150,"150":199}},double:{normal:{"10":40,"24":49,"32":62,"50":79,"75":96,"100":119,"150":169},folded:{"10":65,"24":80,"32":115,"50":149,"75":190,"100":235,"150":325}}},DL:{name:"DL (99x210mm)",single:{normal:{"10":35,"24":50,"32":53,"50":59,"75":70,"100":81,"150":105},folded:{"10":45,"24":55,"32":63,"50":79,"75":97,"100":115,"150":149}},double:{normal:{"10":41,"24":55,"32":64,"50":74,"75":88,"100":105,"150":135},folded:{"10":65,"24":80,"32":90,"50":115,"75":150,"100":185,"150":245}}}}};function ye(e){let{format:t,qty:r,sides:a,isFolded:i,isSatin:o,express:c}=e,d=ae.formats[t];if(!d)throw new Error(`Invalid format: ${t}`);let l=a===1?"single":"double",m=i?"folded":"normal",p=d[l][m],f=Object.keys(p).map(Number).sort((E,z)=>E-z),n=f[0];for(let E of f)r>=E&&(n=E);let y=p[n.toString()],s=u,g=`zap-${t}-${l}-${m}-${n}`,x=`Zaproszenia ${t} ${l==="single"?"1s":"2s"} ${m==="folded"?"sk\u0142":"norm"} (od ${n}szt)`,w=s.register(g,"Zaproszenia",x,y),C=[];o&&C.push({id:"satin",name:"Papier satynowy (+12%)",type:"percentage",value:s.register("zap-mod-satin","Zaproszenia","Satyna (+%)",ae.modifiers.satin)}),c&&C.push({id:"express",name:"EXPRESS (+20%)",type:"percentage",value:s.register("global-express","Global","Express (+%)",.2)});let M=0,k=[];for(let E of C)(E.type==="percent"||E.type==="percentage")&&(M+=w*E.value,k.push(E.name));let A=w+M;return{basePrice:w,effectiveQuantity:r,tierPrice:w/r,modifiersTotal:M,totalPrice:Math.round(A*100)/100,appliedModifiers:k}}var fe={id:"zaproszenia-kreda",name:"Zaproszenia KREDA",async mount(e,t){let r=await fetch("categories/zaproszenia-kreda.html");e.innerHTML=await r.text();let a=e.querySelector("#zapFormat"),i=e.querySelector("#zapSides"),o=e.querySelector("#zapFolded"),c=e.querySelector("#zapQty"),d=e.querySelector("#zapSatin"),l=e.querySelector("#calcBtn"),m=e.querySelector("#addToCartBtn"),p=e.querySelector("#zapResult"),f=()=>{let n={format:a.value,qty:parseInt(c.value)||10,sides:parseInt(i.value)||1,isFolded:o.checked,isSatin:d.checked,express:t.expressMode},y=ye(n);return p.style.display="block",e.querySelector("#resUnitPrice").textContent=S(y.totalPrice/n.qty),e.querySelector("#resTotalPrice").textContent=S(y.totalPrice),e.querySelector("#resExpressHint").style.display=n.express?"block":"none",e.querySelector("#resSatinHint").style.display=n.isSatin?"block":"none",t.updateLastCalculated(y.totalPrice,"Zaproszenia"),{options:n,result:y}};l.addEventListener("click",()=>f()),m.addEventListener("click",()=>{let{options:n,result:y}=f();t.cart.addItem({id:`zap-${Date.now()}`,category:"Zaproszenia Kreda",name:`Zaproszenia ${n.format} ${n.sides===1?"1-str":"2-str"}${n.isFolded?" sk\u0142adane":""}`,quantity:n.qty,unit:"szt",unitPrice:y.totalPrice/n.qty,isExpress:n.express,totalPrice:y.totalPrice,optionsHint:`${n.qty} szt, ${n.isSatin?"Satyna":"Kreda"}`,payload:n})}),f()}};var ge={name:"Ulotki \u2013 cyfrowe",jednostronne:{A6:{name:"A6 (105x148)",tiers:[{min:10,max:10,price:30},{min:20,max:20,price:35},{min:30,max:30,price:40},{min:40,max:40,price:45},{min:50,max:50,price:55},{min:60,max:60,price:61},{min:70,max:70,price:65},{min:80,max:80,price:70},{min:90,max:90,price:75},{min:100,max:100,price:79},{min:150,max:150,price:90},{min:200,max:200,price:110},{min:300,max:300,price:145},{min:400,max:400,price:160},{min:500,max:500,price:190},{min:700,max:700,price:255},{min:1e3,max:1e3,price:320}]},A5:{name:"A5 (148 x 210)",tiers:[{min:10,max:10,price:35},{min:20,max:20,price:42},{min:30,max:30,price:50},{min:40,max:40,price:59},{min:50,max:50,price:69},{min:60,max:60,price:75},{min:70,max:70,price:82},{min:80,max:80,price:88},{min:90,max:90,price:93},{min:100,max:100,price:95},{min:150,max:150,price:130},{min:200,max:200,price:150},{min:300,max:300,price:210},{min:400,max:400,price:259},{min:500,max:500,price:300},{min:700,max:700,price:410},{min:1e3,max:1e3,price:530}]},DL:{name:"DL (99 x 210)",tiers:[{min:10,max:10,price:30},{min:20,max:20,price:35},{min:30,max:30,price:40},{min:40,max:40,price:45},{min:50,max:50,price:55},{min:60,max:60,price:60},{min:70,max:70,price:65},{min:80,max:80,price:70},{min:90,max:90,price:75},{min:100,max:100,price:83},{min:150,max:150,price:100},{min:200,max:200,price:120},{min:300,max:300,price:160},{min:400,max:400,price:199},{min:500,max:500,price:230},{min:700,max:700,price:310},{min:1e3,max:1e3,price:399}]}},dwustronne:{A6:{name:"A6 (105x148)",tiers:[{min:10,max:10,price:40},{min:20,max:20,price:47},{min:30,max:30,price:49},{min:40,max:40,price:55},{min:50,max:50,price:60},{min:60,max:60,price:65},{min:70,max:70,price:70},{min:80,max:80,price:75},{min:90,max:90,price:90},{min:100,max:100,price:95},{min:150,max:150,price:120},{min:200,max:200,price:140},{min:300,max:300,price:190},{min:400,max:400,price:230},{min:500,max:500,price:270},{min:700,max:700,price:365},{min:1e3,max:1e3,price:476}]},A5:{name:"A5 (148 x 210)",tiers:[{min:10,max:10,price:45},{min:20,max:20,price:55},{min:30,max:30,price:60},{min:40,max:40,price:72},{min:50,max:50,price:90},{min:60,max:60,price:99},{min:70,max:70,price:112},{min:80,max:80,price:122},{min:90,max:90,price:130},{min:100,max:100,price:140},{min:150,max:150,price:180},{min:200,max:200,price:220},{min:300,max:300,price:310},{min:400,max:400,price:390},{min:500,max:500,price:460},{min:700,max:700,price:620},{min:1e3,max:1e3,price:790}]},DL:{name:"DL (99 x 210)",tiers:[{min:10,max:10,price:40},{min:20,max:20,price:50},{min:30,max:30,price:55},{min:40,max:40,price:65},{min:50,max:50,price:70},{min:60,max:60,price:78},{min:70,max:70,price:88},{min:80,max:80,price:99},{min:90,max:90,price:109},{min:100,max:100,price:119},{min:150,max:150,price:150},{min:200,max:200,price:179},{min:300,max:300,price:235},{min:400,max:400,price:290},{min:500,max:500,price:350},{min:700,max:700,price:460},{min:1e3,max:1e3,price:590}]}}};function Je(e,t="jednostronne"){let r=ge[t];if(!r)throw new Error(`Invalid mode: ${t}`);let a=r[e];if(!a)throw new Error(`Invalid format: ${e} for mode ${t}`);return{id:`ulotki-${t}-${e.toLowerCase()}`,title:`Ulotki Cyfrowe ${t==="dwustronne"?"Dwustronne":"Jednostronne"} ${a.name}`,unit:"szt",pricing:"flat",tiers:a.tiers,modifiers:[{id:"express",name:"TRYB EXPRESS",type:"percent",value:.2}]}}function xe(e){let t=Je(e.format,e.mode),r=[];return e.express&&r.push("express"),q(t,e.qty,r)}var be={id:"ulotki-cyfrowe-jednostronne",name:"Ulotki \u2013 cyfrowe",async mount(e,t){try{let r=await fetch("categories/ulotki-cyfrowe-jednostronne.html");if(!r.ok)throw new Error("Failed to load template");e.innerHTML=await r.text(),this.initLogic(e,t)}catch(r){e.innerHTML=`<div class="error">B\u0142\u0105d \u0142adowania: ${r}</div>`}},initLogic(e,t){let r=e.querySelector("#uj-format"),a=e.querySelector("#uj-qty-input"),i=e.querySelector("#uj-add-to-cart"),o=e.querySelector("#uj-result-display"),c=e.querySelector("#uj-total-price"),d=e.querySelector("#uj-unit-price"),l=e.querySelector("#uj-display-qty"),m=e.querySelector("#uj-express-hint"),p=e.querySelector("#uj-individual-quote"),f=null,n=null,y=()=>{let s=e.querySelector('input[name="uj-mode"]:checked').value,g=parseInt(a.value)||0,x=r.value;if(g>1e3){o.style.display="none",p.style.display="block",i.disabled=!0;return}if(g<1){o.style.display="none",p.style.display="none",i.disabled=!0;return}p.style.display="none",n={mode:s,format:x,qty:g,express:t.expressMode};try{let w=xe(n);f=w,l.innerText=`${g} szt`,d.innerText=S(w.totalPrice/g),c.innerText=S(w.totalPrice),m&&(m.style.display=t.expressMode?"block":"none"),o.style.display="block",i.disabled=!1,t.updateLastCalculated(w.totalPrice,"Ulotki")}catch(w){console.error(w),o.style.display="none",i.disabled=!0}};e.querySelectorAll('input[name="uj-mode"]').forEach(s=>{s.addEventListener("change",y)}),r.onchange=y,a.oninput=y,i.onclick=()=>{if(f&&n){let s=n.express?", EXPRESS":"",g=n.mode==="dwustronne"?"Dwustronne":"Jednostronne";t.cart.addItem({id:`ulotki-cyfrowe-${Date.now()}`,category:"Ulotki",name:`Ulotki ${g} ${n.format}`,quantity:n.qty,unit:"szt",unitPrice:f.totalPrice/n.qty,isExpress:n.express,totalPrice:f.totalPrice,optionsHint:`${n.qty} szt, ${g}${s}`,payload:f})}},y()}};var he={id:"banner",title:"Bannery",unit:"m2",pricing:"per_unit",materials:[{id:"powlekany",name:"Banner powlekany",tiers:[{min:1,max:25,price:53},{min:26,max:50,price:49},{min:51,max:null,price:45}]},{id:"blockout",name:"Banner Blockout",tiers:[{min:1,max:25,price:64},{min:26,max:50,price:59},{min:51,max:null,price:55}]}],modifiers:[{id:"oczkowanie",name:"Oczkowanie (+2.50 z\u0142/m2)",type:"fixed_per_unit",value:2.5},{id:"express",name:"TRYB EXPRESS (+20%)",type:"percent",value:.2}]};function we(e){let t=he,r=t.materials.find(m=>m.id===e.material);if(!r)throw new Error(`Unknown material: ${e.material}`);let a="Bannery",i=`banner-${e.material}`,o=u.registerTiers(i,a,r.tiers),c=t.modifiers.map(m=>({...m,value:u.register(`banner-mod-${m.id}`,a,`Dop\u0142ata ${m.name}`,m.value)})),d={id:t.id,title:t.title,unit:t.unit,pricing:t.pricing,tiers:o,modifiers:c},l=[];return e.oczkowanie&&l.push("oczkowanie"),e.express&&l.push("express"),q(d,e.areaM2,l)}var ke={id:"banner",name:"Bannery",async mount(e,t){try{let r=await fetch("categories/banner.html");if(!r.ok)throw new Error("Failed to load template");e.innerHTML=await r.text(),this.initLogic(e,t)}catch(r){e.innerHTML=`<div class="error">B\u0142\u0105d \u0142adowania: ${r}</div>`}},initLogic(e,t){let r=e.querySelector("#b-material"),a=e.querySelector("#b-area"),i=e.querySelector("#b-oczkowanie"),o=e.querySelector("#b-calculate"),c=e.querySelector("#b-add-to-cart"),d=e.querySelector("#b-result-display"),l=e.querySelector("#b-unit-price"),m=e.querySelector("#b-total-price"),p=e.querySelector("#b-express-hint"),f=null,n=null;o.onclick=()=>{n={material:r.value,areaM2:parseFloat(a.value),oczkowanie:i.checked,express:t.expressMode};try{let y=we(n);f=y,l.innerText=S(y.tierPrice),m.innerText=S(y.totalPrice),p&&(p.style.display=t.expressMode?"block":"none"),d.style.display="block",c.disabled=!1,t.updateLastCalculated(y.totalPrice,"Banner")}catch(y){alert("B\u0142\u0105d: "+y.message)}},c.onclick=()=>{if(f&&n){let y=r.options[r.selectedIndex].text,s=[`${n.areaM2} m2`,n.oczkowanie?"z oczkowaniem":"bez oczkowania",n.express?"EXPRESS":""].filter(Boolean).join(", ");t.cart.addItem({id:`banner-${Date.now()}`,category:"Bannery",name:y,quantity:n.areaM2,unit:"m2",unitPrice:f.tierPrice,isExpress:n.express,totalPrice:f.totalPrice,optionsHint:s,payload:f})}}}};var _={};Re(_,{category:()=>Ye,default:()=>rt,groups:()=>et,modifiers:()=>tt});var Ye="Wlepki / Naklejki",et=[{id:"wlepki_obrys_folia",title:"Wlepki po obrysie (Folia Bia\u0142a/Trans)",unit:"m2",pricing:"per_unit",tiers:[{min:1,max:5,price:67},{min:6,max:25,price:60},{min:26,max:50,price:52},{min:51,max:null,price:48}],rules:[{type:"minimum",unit:"m2",value:1}]},{id:"wlepki_polipropylen",title:"Wlepki po obrysie - Polipropylen",unit:"m2",pricing:"per_unit",tiers:[{min:1,max:10,price:50},{min:11,max:null,price:42}],rules:[{type:"minimum",unit:"m2",value:1}]},{id:"wlepki_standard_folia",title:"Folia Bia\u0142a / Transparentna (standard)",unit:"m2",pricing:"per_unit",tiers:[{min:1,max:5,price:54},{min:6,max:25,price:50},{min:26,max:50,price:46},{min:51,max:null,price:42}],rules:[{type:"minimum",unit:"m2",value:1}]}],tt=[{id:"mocny_klej",name:"Mocny klej",type:"percent",value:.12},{id:"arkusze",name:"Ci\u0119te na arkusze",type:"fixed_per_unit",value:2},{id:"pojedyncze",name:"Ci\u0119te na pojedyncze sztuki",type:"fixed_per_unit",value:10},{id:"express",name:"EXPRESS",type:"percent",value:.2}],rt={category:Ye,groups:et,modifiers:tt};function ve(e){let t=_,r=t.groups.find(o=>o.id===e.groupId);if(!r)throw new Error(`Unknown group: ${e.groupId}`);let a={id:`wlepki-${r.id}`,title:r.title,unit:r.unit,pricing:r.pricing||"per_unit",tiers:r.tiers,modifiers:t.modifiers,rules:r.rules||[{type:"minimum",unit:"m2",value:1}]},i=[...e.modifiers];return e.express&&i.push("express"),q(a,e.area,i)}var Se={id:"wlepki-naklejki",name:"Wlepki / Naklejki",async mount(e,t){let r=_;try{let y=await fetch("categories/wlepki-naklejki.html");if(!y.ok)throw new Error("Failed to load template");e.innerHTML=await y.text()}catch(y){e.innerHTML=`<div class="error">B\u0142\u0105d \u0142adowania szablonu: ${y}</div>`;return}let a=e.querySelector("#wlepki-group"),i=e.querySelector("#wlepki-area"),o=e.querySelector("#btn-calculate"),c=e.querySelector("#btn-add-to-cart"),d=e.querySelector("#wlepki-result"),l=e.querySelector("#unit-price"),m=e.querySelector("#total-price"),p=null,f=null,n=()=>{let y=e.querySelectorAll(".wlepki-mod:checked"),s=Array.from(y).map(g=>g.value);f={groupId:a.value,area:parseFloat(i.value)||0,express:t.expressMode,modifiers:s};try{let g=ve(f);p=g,l.textContent=S(g.tierPrice),m.textContent=S(g.totalPrice),d.style.display="block",c.disabled=!1,t.updateLastCalculated(g.totalPrice,"Wlepki")}catch(g){alert("B\u0142\u0105d: "+g.message)}};o.addEventListener("click",n),c.addEventListener("click",()=>{if(!p||!f)return;let y=r.groups.find(g=>g.id===f.groupId),s=f.modifiers.map(g=>{let x=r.modifiers.find(w=>w.id===g);return x?x.name:g});f.express&&s.unshift("EXPRESS (+20%)"),t.cart.addItem({id:`wlepki-${Date.now()}`,category:"Wlepki / Naklejki",name:y?.title||"Wlepki",quantity:f.area,unit:"m2",unitPrice:p.tierPrice,isExpress:!!f.express,totalPrice:p.totalPrice,optionsHint:s.join(", ")||"Standard",payload:p})})}};var Z={name:"Roll-up Jednostronny",formats:{"85x200":{width:.85,height:2,tiers:[{min:1,max:5,price:290},{min:6,max:10,price:275}]},"100x200":{width:1,height:2,tiers:[{min:1,max:5,price:305},{min:6,max:10,price:285}]},"120x200":{width:1.2,height:2,tiers:[{min:1,max:5,price:330},{min:6,max:10,price:310}]},"150x200":{width:1.5,height:2,tiers:[{min:1,max:5,price:440},{min:6,max:10,price:425}]}},replacement:{labor:50,print_per_m2:80}};function Ee(e){let t=Z.formats[e.format];if(!t)throw new Error(`Unknown format: ${e.format}`);let r="Roll-up",a;if(e.isReplacement){let o=t.width*t.height,c=u.register("rollup-repl-m2",r,"Wymiana: Druk za m2",Z.replacement.print_per_m2),d=u.register("rollup-repl-labor",r,"Wymiana: Robocizna",Z.replacement.labor),l=o*c+d,m=u.register("rollup-repl-express",r,"Dop\u0142ata Express (wymiana)",.2);a={id:"roll-up-replacement",title:`Wymiana wk\u0142adu (${e.format})`,unit:"szt",pricing:"per_unit",tiers:[{min:1,max:null,price:l}],modifiers:[{id:"express",name:"EXPRESS",type:"percent",value:m}]}}else{let o=`rollup-full-${e.format}`,c=u.registerTiers(o,r,t.tiers),d=u.register(`${o}-express`,r,`Dop\u0142ata Express (${e.format})`,.2);a={id:"roll-up-full",title:`Roll-up Komplet (${e.format})`,unit:"szt",pricing:"per_unit",tiers:c,modifiers:[{id:"express",name:"EXPRESS",type:"percent",value:d}]}}let i=[];return e.express&&i.push("express"),q(a,e.qty,i)}var Te={id:"roll-up",name:"Roll-up",async mount(e,t){let r=await fetch("categories/roll-up.html");e.innerHTML=await r.text();let a=e.querySelector("#rollUpType"),i=e.querySelector("#rollUpFormat"),o=e.querySelector("#rollUpQty"),c=e.querySelector("#calcBtn"),d=e.querySelector("#addToCartBtn"),l=e.querySelector("#rollUpResult"),m=()=>{let p={format:i.value,qty:parseInt(o.value)||1,isReplacement:a.value==="replacement",express:t.expressMode},f=Ee(p);return l.style.display="block",e.querySelector("#resUnitPrice").textContent=S(f.totalPrice/p.qty),e.querySelector("#resTotalPrice").textContent=S(f.totalPrice),e.querySelector("#resExpressHint").style.display=p.express?"block":"none",t.updateLastCalculated(f.totalPrice,"Roll-up"),{options:p,result:f}};c.addEventListener("click",()=>m()),d.addEventListener("click",()=>{let{options:p,result:f}=m();t.cart.addItem({id:`rollup-${Date.now()}`,category:"Roll-up",name:`${p.isReplacement?"Wymiana wk\u0142adu":"Roll-up Komplet"} ${p.format}`,quantity:p.qty,unit:"szt",unitPrice:f.totalPrice/p.qty,isExpress:p.express,totalPrice:f.totalPrice,optionsHint:`${p.format}, ${p.qty} szt`,payload:p})}),m()}};async function it(e){let t=await fetch(`./categories/${e}`);if(!t.ok)throw new Error(`Failed to load ${e}`);return t.text()}function X(e,t,r){return{id:e,name:t,mount:async(a,i)=>{a.innerHTML='<div style="padding: 20px; text-align: center; color: #999;">\u23F3 \u0141adowanie kategorii...</div>';try{let o=await it(r);a.innerHTML=o,ot(a,i)}catch(o){a.innerHTML=`
        ...
        `}).join(""),e.querySelectorAll(".fold-check").forEach(h=>{h.addEventListener("change",v=>{l[parseInt(v.target.dataset.idx)].folding=v.target.checked,F()})}),e.querySelectorAll(".scan-check").forEach(h=>{h.addEventListener("change",v=>{l[parseInt(v.target.dataset.idx)].scanning=v.target.checked,F()})});let b=0;l.forEach(h=>{b+=(J(h)+G(h)+Y(h))*(t.expressMode?1.2:1)}),M.innerHTML=`
        <div class="summary-item"><span>Liczba plik\xF3w:</span><span>${l.length}</span></div>
        <div class="summary-item"><span>Razem brutto:</span><strong>${b.toFixed(2)} z\u0142</strong></div>
      `,t.updateLastCalculated(b,`Druk CAD (${l.length} plik\xF3w)`)};n.onclick=()=>f.click(),f.onchange=b=>{let h=b.target.files;for(let v of h)if(v.type.startsWith("image/")||v.type==="application/pdf"){let T=new Image,L=new FileReader;L.onload=I=>{T.onload=()=>{let B=E(T.width,p),V=E(T.height,p);l.push({name:v.name,widthPx:T.width,heightPx:T.height,widthMm:B,heightMm:V,formatInfo:H(B,V),folding:!1,scanning:!1}),F()},T.src=I.target.result},L.readAsDataURL(v)}else{let T=E(2480,p),L=E(3508,p);l.push({name:v.name,widthPx:2480,heightPx:3508,widthMm:T,heightMm:L,formatInfo:H(T,L),folding:!1,scanning:!1}),F()}},s.onclick=()=>{m=!m,g.classList.toggle("active"),F()},y.onchange=()=>{p=parseInt(y.value)||300,l=l.map(b=>{let h=E(b.widthPx,p),v=E(b.heightPx,p);return{...b,widthMm:h,heightMm:v,formatInfo:H(h,v)}}),F()},k.onclick=()=>{l=[],F()},A.onclick=()=>{l.forEach(b=>{let h=J(b),v=G(b),T=Y(b),L=(h+v+T)*(t.expressMode?1.2:1);t.cart.addItem({id:`cad-${Date.now()}-${Math.random()}`,category:"Druk CAD",name:b.name,quantity:1,unit:"szt.",unitPrice:L,isExpress:t.expressMode,totalPrice:parseFloat(L.toFixed(2)),optionsHint:`${b.formatInfo.format} (${m?"Kolor":"CZ-B"}), ${b.folding?"Sk\u0142adanie":""}`,payload:b})}),alert(`Dodano ${l.length} plik\xF3w do koszyka.`)}}};function oe(e,t){return e.find(r=>t>=r.from&&t<=r.to)||null}var j=(e,t,r)=>u.registerTiers(e,t,r),P={get print(){return{bw:{A4:j("print-bw-a4","Druk A4/A3",[{from:1,to:5,unit:.9},{from:6,to:20,unit:.6},{from:21,to:100,unit:.35},{from:101,to:500,unit:.3},{from:501,to:999,unit:.23},{from:1e3,to:4999,unit:.19},{from:5e3,to:99999,unit:.15}]),A3:j("print-bw-a3","Druk A4/A3",[{from:1,to:5,unit:1.7},{from:6,to:20,unit:1.1},{from:21,to:100,unit:.7},{from:101,to:500,unit:.6},{from:501,to:999,unit:.45},{from:1e3,to:99999,unit:.33}])},color:{A4:j("print-color-a4","Druk A4/A3",[{from:1,to:10,unit:2.4},{from:11,to:40,unit:2.2},{from:41,to:100,unit:2},{from:101,to:250,unit:1.8},{from:251,to:500,unit:1.6},{from:501,to:999,unit:1.4},{from:1e3,to:99999,unit:1.1}]),A3:j("print-color-a3","Druk A4/A3",[{from:1,to:10,unit:4.8},{from:11,to:40,unit:4.2},{from:41,to:100,unit:3.8},{from:101,to:250,unit:3},{from:251,to:500,unit:2.5},{from:501,to:999,unit:1.9},{from:1e3,to:99999,unit:1.6}])}}},get scan(){return{auto:j("scan-auto","Skany",[{from:1,to:9,unit:1},{from:10,to:49,unit:.5},{from:50,to:99,unit:.4},{from:100,to:999999999,unit:.25}]),manual:j("scan-manual","Skany",[{from:1,to:4,unit:2},{from:5,to:999999999,unit:1}])}},get email_price(){return u.get("email-price",1)}},ie={get color(){return{formatowe:{A0p:u.get("cad-color-f-a0p",26),A0:u.get("cad-color-f-a0",24),A1:u.get("cad-color-f-a1",12),A2:u.get("cad-color-f-a2",8.5),A3:u.get("cad-color-f-a3",5.3)},mb:{A0p:u.get("cad-color-m-a0p",21),A0:u.get("cad-color-m-a0",20),A1:u.get("cad-color-m-a1",14.5),A2:u.get("cad-color-m-a2",13.9),A3:u.get("cad-color-m-a3",12),R1067:u.get("cad-color-m-r1067",30)}}},get bw(){return{formatowe:{A0p:u.get("cad-bw-f-a0p",12.5),A0:u.get("cad-bw-f-a0",11),A1:u.get("cad-bw-f-a1",6),A2:u.get("cad-bw-f-a2",4),A3:u.get("cad-bw-f-a3",2.5)},mb:{A0p:u.get("cad-bw-m-a0p",10),A0:u.get("cad-bw-m-a0",9),A1:u.get("cad-bw-m-a1",5),A2:u.get("cad-bw-m-a2",4.5),A3:u.get("cad-bw-m-a3",3.5),R1067:u.get("cad-bw-m-r1067",12.5)}}}};var Ce={get A0p(){return u.get("fold-a0p",4)},get A0(){return u.get("fold-a0",3)},get A1(){return u.get("fold-a1",2)},get A2(){return u.get("fold-a2",1.5)},get A3(){return u.get("fold-a3",1)},get A3L(){return u.get("fold-a3l",.7)}},ze={get value(){return u.get("wf-scan-cm",.08)}},D=(e,t,r,a)=>{let i={};for(let[o,c]of Object.entries(a)){let d=`biz-${e}-${t}-${r}-${o}`,l=`Wizyt\xF3wki ${t} ${r} ${o} szt`;i[o]=u.register(d,"Wizyt\xF3wki",l,c)}return i},Me={get cyfrowe(){return{standardPrices:{"85x55":{noLam:D("std","85x55","bez lami",{50:65,100:75,150:85,200:96,250:110,300:126,400:146,500:170,1e3:290}),lam:D("std","85x55","lami",{50:160,100:170,150:180,200:190,250:200,300:220,400:240,500:250,1e3:335})},"90x50":{noLam:D("std","90x50","bez lami",{50:70,100:79,150:89,200:99,250:120,300:129,400:149,500:175,1e3:300}),lam:D("std","90x50","lami",{50:170,100:180,150:190,200:200,250:210,300:230,400:250,500:260,1e3:345})}},softtouchPrices:{"85x55":{noLam:D("st","85x55","bez lami",{50:65,100:75,150:85,200:96,250:110,300:126,400:145,500:170,1e3:290}),lam:D("st","85x55","lami",{50:170,100:190,150:210,200:220,250:230,300:240,400:260,500:270,1e3:380})},"90x50":{noLam:D("st","90x50","bez lami",{50:70,100:79,150:89,200:99,250:120,300:129,400:149,500:175,1e3:300}),lam:D("st","90x50","lami",{50:170,100:190,150:210,200:220,250:230,300:240,400:260,500:270,1e3:390})}},deluxe:{leadTime:"4\u20135 dni roboczych",options:{uv3d_softtouch:{label:"Maker UV 3D + folia SOFTTOUCH",prices:D("deluxe","UV 3D","Softtouch",{50:280,100:320,200:395,250:479,400:655,500:778})},uv3d_gold_softtouch:{label:"Maker UV 3D + z\u0142ocenie + folia SOFTTOUCH",prices:D("deluxe","UV 3D Gold","Softtouch",{50:450,100:550,200:650,250:720,400:850,500:905})}}}}}},nt=()=>{let e=P.print,t=P.scan,r=P.email_price,a=ie.color,i=ie.bw,o=Ce.A0,c=ze.value,d=Me.cyfrowe};nt();function Ae(e){if(e.pages<=0)return{unitPrice:0,printTotal:0,emailTotal:e.email?P.email_price:0,inkTotal:0,grandTotal:e.email?P.email_price:0};let t=P.print[e.mode][e.format],r=oe(t,e.pages);if(!r)throw new Error("Brak progu cenowego dla druku.");let a=r.unit,i=e.pages*a,o=0;e.email&&(o=P.email_price);let c=0;return e.ink25&&(c=.5*a*e.ink25Qty),{unitPrice:a,printTotal:i,emailTotal:o,inkTotal:c,grandTotal:i+o+c}}function qe(e){if(e.pages<=0)return{unitPrice:0,total:0};let t=P.scan[e.type],r=oe(t,e.pages);if(!r)throw new Error("Brak progu cenowego dla skanowania.");let a=r.unit;return{unitPrice:a,total:e.pages*a}}function Pe(e,t){let r=e.format.toUpperCase(),a=Ae({mode:e.mode,format:r,pages:e.printQty,email:e.email,ink25:e.surcharge,ink25Qty:e.surchargeQty}),i={total:0,unitPrice:0};e.scanType!=="none"&&e.scanQty>0&&(i=qe({type:e.scanType,pages:e.scanQty}));let o=a.grandTotal+i.total,c=o;return e.express&&(c=o*1.2),{totalPrice:parseFloat(c.toFixed(2)),unitPrintPrice:a.unitPrice,totalPrintPrice:a.printTotal,unitScanPrice:i.unitPrice,totalScanPrice:i.total,emailPrice:a.emailTotal,surchargePrice:a.inkTotal,baseTotal:o}}var De={id:"druk-a4-a3",name:"Druk A4/A3 + skan",async mount(e,t){try{let r=await fetch("categories/druk-a4-a3-skan.html");if(!r.ok)throw new Error("Failed to load template");e.innerHTML=await r.text(),this.initLogic(e,t)}catch(r){e.innerHTML=`<div class="error">B\u0142\u0105d \u0142adowania: ${r}</div>`}},initLogic(e,t){let r=e.querySelector("#d-mode"),a=e.querySelector("#d-format"),i=e.querySelector("#d-print-qty"),o=e.querySelector("#d-email"),c=e.querySelector("#d-surcharge"),d=e.querySelector("#d-surcharge-qty"),l=e.querySelector("#surcharge-qty-row"),m=e.querySelector("#d-scan-type"),p=e.querySelector("#d-scan-qty"),f=e.querySelector("#scan-qty-row"),n=e.querySelector("#d-calculate"),y=e.querySelector("#d-add-to-cart"),s=e.querySelector("#d-result-display"),g=e.querySelector("#d-total-price"),x=e.querySelector("#d-express-hint"),w=e.querySelector("#tier-table"),C=()=>{if(!w||!r||!a)return;let A=r.value,E=a.value.toUpperCase(),R=P.print[A][E];R&&(w.innerHTML=R.map(H=>`<div>${H.from}-${H.to>=99999?"\u221E":H.to} szt.</div><div style="text-align: right;">${H.unit.toFixed(2)} z\u0142</div>`).join(""))};r&&(r.onchange=C),a&&(a.onchange=C),C(),c&&l&&(c.onchange=()=>{l.style.display=c.checked?"flex":"none"}),m&&f&&(m.onchange=()=>{f.style.display=m.value!=="none"?"flex":"none"});let M=null,k=null;n&&(n.onclick=()=>{k={mode:r.value,format:a.value,printQty:parseInt(i.value)||0,email:o.checked,surcharge:c.checked,surchargeQty:parseInt(d.value)||0,scanType:m.value,scanQty:parseInt(p.value)||0,express:t.expressMode};try{let A=Pe(k);M=A,g.innerText=S(A.totalPrice),x&&(x.style.display=t.expressMode?"block":"none"),s.style.display="block",y.disabled=!1,t.updateLastCalculated(A.totalPrice,"Druk A4/A3 + skan")}catch(A){alert("B\u0142\u0105d: "+A.message)}}),y&&(y.onclick=()=>{if(M&&k){let A=Date.now(),E=t.expressMode?1.2:1;if(k.printQty>0||k.scanQty>0&&k.scanType!=="none"){let z=[];k.printQty>0&&z.push(`${k.printQty} str. ${k.format.toUpperCase()} (${k.mode==="bw"?"CZ-B":"KOLOR"})`),k.scanQty>0&&k.scanType!=="none"&&z.push(`Skan ${k.scanType}: ${k.scanQty} str.`),t.expressMode&&z.push("EXPRESS");let R=(M.totalPrintPrice+M.totalScanPrice)*E;t.cart.addItem({id:`druk-${A}-main`,category:"Druk A4/A3 + skan",name:`${k.format.toUpperCase()} ${k.mode==="bw"?"CZ-B":"KOLOR"}`,quantity:k.printQty||k.scanQty,unit:k.printQty>0?"str.":"skan",unitPrice:R/(k.printQty||k.scanQty),isExpress:t.expressMode,totalPrice:parseFloat(R.toFixed(2)),optionsHint:z.join(", "),payload:{...M,type:"main"}})}if(k.email){let z=M.emailPrice*E;t.cart.addItem({id:`email-${A}-email`,category:"Druk A4/A3 + skan",name:"Wysy\u0142ka e-mail",quantity:1,unit:"szt.",unitPrice:z,isExpress:t.expressMode,totalPrice:parseFloat(z.toFixed(2)),optionsHint:t.expressMode?"EXPRESS":"",payload:{price:z,type:"email"}})}if(k.surcharge&&k.surchargeQty>0){let z=M.surchargePrice*E;t.cart.addItem({id:`surcharge-${A}-surcharge`,category:"Druk A4/A3 + skan",name:"Zadruk >25% - dop\u0142ata",quantity:k.surchargeQty,unit:"str.",unitPrice:z/k.surchargeQty,isExpress:t.expressMode,totalPrice:parseFloat(z.toFixed(2)),optionsHint:`${k.surchargeQty} str. (+50%), ${t.expressMode?"EXPRESS":""}`,payload:{price:z,type:"surcharge"}})}}})}};var Ie=[se,ce,de,pe,ue,fe,be,ke,Se,Te,Le,De,X("cad-ops","\u{1F5FA}\uFE0F CAD OPS","cad-ops.html"),X("folia-szroniona","\u2728 Folia Szroniona","folia-szroniona.html"),X("laminowanie","\u{1F512} Laminowanie","laminowanie.html")];var $e={SETTINGS_PIN:"2024"};var He={id:"settings",name:"\u2699\uFE0F Ustawienia",mount:(e,t)=>{let r=u.getAllEntries(),a=Array.from(new Set(r.map(n=>n.category))).sort();e.innerHTML=`
    ...
    `;let i=e.querySelector("#price-table-body"),o=e.querySelector("#filter-category"),c=e.querySelector("#save-success"),d=e.querySelector("#close-success");function l(n=""){let y=n?r.filter(s=>s.category===n):r;i.innerHTML=y.map(s=>`
      ...
      `).join("")}function m(){let n=e.querySelectorAll(".price-input"),y={},s=0;if(n.forEach(g=>{let x=g.value;if(x!==""&&!isNaN(parseFloat(x))){let w=parseFloat(x),C=g.getAttribute("data-id"),M=r.find(k=>k.id===C);M&&M.currentValue!==w&&(y[C]=w,s++)}}),s>0){u.updatePrices(y);let g=u.getAllEntries();r.forEach(x=>{y[x.id]!==void 0&&(x.currentValue=y[x.id])}),l(o.value),c&&(c.style.display="flex")}else alert("Brak zmian do zapisania.")}let p=e.querySelectorAll(".tab-btn"),f=e.querySelectorAll(".tab-content");p.forEach(n=>{n.addEventListener("click",()=>{let y=n.getAttribute("data-tab");p.forEach(s=>s.classList.remove("active")),n.classList.add("active"),f.forEach(s=>{s.id===y?s.style.display="block":s.style.display="none"})})}),o.addEventListener("change",()=>l(o.value)),e.querySelectorAll(".save-btn").forEach(n=>n.addEventListener("click",m)),d?.addEventListener("click",()=>{c&&(c.style.display="none")}),l()}};var $=new U;function O(){let e=document.getElementById("basket-items"),t=document.getElementById("basket-total"),r=document.getElementById("json-preview");if(!e||!t||!r)return;let a=$.getItems();if(a.length===0)e.innerHTML=`
      <p style="color: #999; text-align: center; padding: 20px;">
        Brak pozycji<br>
        <small>Kliknij \u201EDodaj\u201D, aby zbudowa\u0107 list\u0119.</small>
      </p>
    `,t.textContent="0,00 z\u0142";else{e.innerHTML=a.map((o,c)=>`
      <div class="basket-item" style="padding: 12px; border-radius: 8px; margin-bottom: 8px;">
        <div style="display: flex; justify-content: space-between; align-items: start;">
          ...
          <div style="text-align: right; margin-left: 10px; flex-shrink: 0;">
            ...
            <button onclick="window.removeItem(${c})" style="display: block; width: 100%; margin-top: 4px; background: none; border: none; color: #f56565; cursor: pointer; font-size: 12px; text-align: right; padding: 0;">\u2715 usu\u0144</button>
          </div>
        </div>
      </div>
    `).join("");let i=$.getGrandTotal();t.innerText=S(i)}r.innerText=JSON.stringify(a.map(i=>i.payload),null,2)}window.removeItem=e=>{$.removeItem(e),O()};document.addEventListener("DOMContentLoaded",()=>{let e=document.getElementById("viewContainer"),t=document.getElementById("categorySelector"),r=document.getElementById("categorySearch"),a=document.getElementById("tryb-express");if(!e||!t||!a||!r)return;let i=()=>({cart:{addItem:s=>{$.addItem(s),O()}},addToBasket:s=>{$.addItem({id:`item-${Date.now()}`,category:s.category,name:s.description||"Produkt",quantity:1,unit:"szt.",unitPrice:s.price,isExpress:a.checked,totalPrice:s.price,optionsHint:s.description||"",payload:s}),O()},expressMode:a.checked,updateLastCalculated:(s,g)=>{let x=document.getElementById("last-calculated"),w=document.getElementById("currentHint");x&&(x.innerText=S(s)),w&&(w.innerText=g?`(${g})`:"")}}),o=new K(e,i);o.setCategories(te),Ie.forEach(s=>{o.addRoute(s)}),o.addRoute(He);let c={};te.forEach(s=>{let g=s.group||"Inne";if(!c[g]){let w=document.createElement("optgroup");w.label=g,t.appendChild(w),c[g]=w}let x=document.createElement("option");x.value=s.id,x.innerText=`${s.icon} ${s.name}`,s.implemented||(x.disabled=!0,x.innerText+=" (wkr\xF3tce)"),c[g].appendChild(x)}),t.addEventListener("change",()=>{let s=t.value;s?window.location.hash=`#/${s}`:window.location.hash="#/"}),r.addEventListener("input",()=>{let s=r.value.toLowerCase();Array.from(t.options).forEach((x,w)=>{if(w===0)return;let C=x.text.toLowerCase();x.hidden=!C.includes(s)})}),r.addEventListener("keydown",s=>{if(s.key==="Enter"){let g=r.value.toLowerCase(),x=Array.from(t.options).find((w,C)=>C>0&&!w.hidden&&!w.disabled);x&&(t.value=x.value,window.location.hash=`#/${x.value}`,r.value="")}}),window.addEventListener("hashchange",()=>{let g=(window.location.hash||"#/").slice(2);t.value=g}),a.addEventListener("change",()=>{let s=window.location.hash;window.location.hash="",window.location.hash=s}),document.getElementById("clear-basket")?.addEventListener("click",()=>{$.clear(),O()}),document.getElementById("export-excel")?.addEventListener("click",()=>{let s={name:document.getElementById("client-name").value||"Anonim",phone:document.getElementById("client-phone").value||"-",email:document.getElementById("client-email").value||"-",priority:document.getElementById("priority").value};if($.isEmpty()){alert("Lista jest pusta!");return}ne($.getItems(),s)}),document.getElementById("copy-json")?.addEventListener("click",()=>{let s=$.getItems(),g=JSON.stringify(s.map(x=>x.payload),null,2);navigator.clipboard.writeText(g).then(()=>{alert("JSON skopiowany do schowka!")})}),O(),o.start();let d=document.getElementById("settings-btn"),l=document.getElementById("pin-modal"),m=document.getElementById("pin-input"),p=document.getElementById("pin-submit"),f=document.getElementById("pin-cancel"),n=document.getElementById("pin-error");d?.addEventListener("click",()=>{l&&(l.style.display="flex"),m?.focus()}),f?.addEventListener("click",()=>{l&&(l.style.display="none"),m&&(m.value=""),n&&(n.style.display="none")});let y=()=>{m?.value===$e.SETTINGS_PIN?(l&&(l.style.display="none"),m.value="",n&&(n.style.display="none"),window.location.hash="#/settings"):(n&&(n.style.display="block"),m&&(m.value="",m.focus()))};p?.addEventListener("click",y),m?.addEventListener("keydown",s=>{s.key==="Enter"&&y()})});"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js").then(e=>console.log("SW registered",e)).catch(e=>console.error("SW failed",e))});
